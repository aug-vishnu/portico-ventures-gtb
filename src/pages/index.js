      ...
      <header className="main-header">
          ...
          <div className="hero-section">
              ...
              <div id="content-part" className="banner">
                  <h1>We are an investment firm specialising in investments in emerging <strong>cryptoassets &amp;
                          blockchain startups.</strong> </h1>
                  <p>We are a team of investors who have been highly active participants in the blockchain space over the
                      better half of the last decade. We formed Portico ventures, to prepare founders for the challenges
                      they will face building in a constantly evolving market.</p>
                  <p>We believe the blockchain space has ample room to grow. If you are building something that you
                      strongly believe in, please reach out.</p>
              </div>
              {/* <div id="image-part">
          ...
          <div className="footer-top">
              ...
              <div className="part-two col-lg-4">
                  <div className="footer-social">
                      <a href="youtube.com" className="social btn"><svg width={13} height={12} viewBox="0 0 13 12"
                      ...
                      <a href="youtube.com" className="social btn"><svg width={18} height={17} viewBox="0 0 18 17"
                              fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path

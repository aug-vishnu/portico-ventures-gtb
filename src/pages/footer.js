    ...
    <Layout>
        <footer>
            ...
            <div className="footer-social">
                <a href={CFooter['linkedin']} className="social btn"><svg width={13} height={12} viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* <a href={CFooter['twitter']} className="social btn"><svg width={8} height={13} viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href={CFooter['twitter']} className="social btn"><svg width={14} height={11} viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href={CFooter['github']} className="social btn"><svg width={18} height={17} viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
